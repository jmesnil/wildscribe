...
public class PathElement {
    ...
    PathElement(final String key, final String value) {
        ...
        if (value == null || value.isEmpty()) {
            final String element = key + "=" + value;
            throw new OperationClientIllegalArgumentException(String.format("Invalid resource address element '%s'. The value '%s' is not valid for an element in a resource address. Character '%s' is not allowed.", element, value, ' '));
        }
     ...
     */
    private static class OperationClientIllegalArgumentException extends IllegalArgumentException{
